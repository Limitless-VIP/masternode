...
(
  ...
  do
    ...
    then
      ...
      echo
      echo "If this exact same issue keeps happening please let Limitless in discord."
...
if [[ -s ~/masternode.limitless.key ]]
then
  cp ~/masternode.limitless.key "${USR_HOME}/masternode.limitless.key"
fi
